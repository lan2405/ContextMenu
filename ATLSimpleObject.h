...
class ATL_NO_VTABLE CATLSimpleObject :
	...
	public IDispatchImpl<IATLSimpleObject, &IID_IATLSimpleObject, &LIBID_mainLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
	public IContextMenu,
...
public:
	HRESULT IShellExtInit(PCIDLIST_ABSOLUTE pidlFolder, IDataObject* pdtobj, HKEY hkeyProgID);
