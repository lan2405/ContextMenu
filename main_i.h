 ...
 */
/* Compiler settings for main.idl:
...
#ifndef __IContextMenuGreat_FWD_DEFINED__
#define __IContextMenuGreat_FWD_DEFINED__
typedef interface IContextMenuGreat IContextMenuGreat;

#endif 	/* __IContextMenuGreat_FWD_DEFINED__ */
...
#ifndef __ContextMenuGreat_FWD_DEFINED__
#define __ContextMenuGreat_FWD_DEFINED__

#ifdef __cplusplus
typedef class ContextMenuGreat ContextMenuGreat;
#else
typedef struct ContextMenuGreat ContextMenuGreat;
#endif /* __cplusplus */

#endif 	/* __ContextMenuGreat_FWD_DEFINED__ */
...
#ifndef __IContextMenuGreat_INTERFACE_DEFINED__
#define __IContextMenuGreat_INTERFACE_DEFINED__

/* interface IContextMenuGreat */
/* [unique][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IContextMenuGreat;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("bb0d4f03-31d1-4b59-8296-7bac734f2d67")
    IContextMenuGreat : public IDispatch
    {
    public:
    };
    ...
    typedef struct IContextMenuGreatVtbl
    {
        BEGIN_INTERFACE
        
        DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            IContextMenuGreat * This,
            /* [in] */ REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        END_INTERFACE
    } IContextMenuGreatVtbl;

    interface IContextMenuGreat
    {
        CONST_VTBL struct IContextMenuGreatVtbl *lpVtbl;
    };
...
#define IContextMenuGreat_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IContextMenuGreat_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IContextMenuGreat_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IContextMenuGreat_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IContextMenuGreat_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IContextMenuGreat_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IContextMenuGreat_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 
...
#endif 	/* __IContextMenuGreat_INTERFACE_DEFINED__ */



#ifndef __mainLib_LIBRARY_DEFINED__
#define __mainLib_LIBRARY_DEFINED__

/* library mainLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_mainLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("7e9a7989-5402-4cff-a8b8-cf769972d901")
CompReg;
#endif

EXTERN_C const CLSID CLSID_ContextMenuGreat;

#ifdef __cplusplus

class DECLSPEC_UUID("f769a6c4-e8c1-4343-8363-5a751b1f27d7")
ContextMenuGreat;
#endif
#endif /* __mainLib_LIBRARY_DEFINED__ */
